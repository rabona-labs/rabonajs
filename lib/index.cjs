...
var Pitch = (_class = class {
  ...
  addLayer(layer) {
    ...
    for (const pass of layer.data) {
      (_a = this.pitch) == null ? void 0 : _a.append("line").style("stroke", "magenta").style("stroke-width", 1.2).attr("x1", pass.startX * this.pitchOptions.scaler + 50).attr("y1", pass.startY * this.pitchOptions.scaler + 50).attr("x2", pass.endX * this.pitchOptions.scaler + 50).attr("y2", pass.endY * this.pitchOptions.scaler + 50);
    }
    return this;
  }
}, _class);
